      ...
      <section className="relative z-20 max-w-3xl mx-auto px-6 md:px-10 py-16 text-center">
        <motion.div {...fadeDelay(0.1)}>
          ...
          <p className="text-lg md:text-xl text-[#57534E] font-light leading-relaxed mb-8">
            Peer support is powerful, but sometimes you need more. <a href="/psychologist" className="underline underline-offset-4 decoration-[#A8A29E]/40 hover:text-[#1C1917] transition-colors duration-300">Connect with a licensed therapist</a> who understands college life, or let <a href="/peacebot" className="underline underline-offset-4 decoration-[#A8A29E]/40 hover:text-[#1C1917] transition-colors duration-300">Peace Bot guide you through difficult moments</a> at any hour. Need a quick reset? Try our <a href="/breathe" className="underline underline-offset-4 decoration-[#A8A29E]/40 hover:text-[#1C1917] transition-colors duration-300">60-second breathing exercises</a>.
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm text-[#78716C] font-light">
            ...
            <span className="text-[#D6D3D1]">·</span>
            <a href="/community" className="hover:text-[#1C1917] transition-colors duration-300">Student community →</a>
          </div>
        </motion.div>
      </section>
