    ...
    >
      ...
      >
        ...
        <motion.div layout className="flex items-center shrink-0">
          ...
          <a href="https://app.peacecode.in/auth" className={`sm:hidden inline-flex items-center rounded-full px-5 py-2 text-[14px] font-medium transition-all duration-500 mr-2 ${scrolled ? "bg-slate-900 text-white shadow-sm hover:bg-slate-800" : "bg-white text-slate-900 shadow-sm"}`}>
            Log In
          </a>
